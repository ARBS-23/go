...
const file_proto_todo_proto_rawDesc = "" +
	"\n" +
	"\x10proto/todo.proto\x12\x05proto\"\a\n" +
	"\x05Empty\"\x18\n" +
	"\x06TodoId\x12\x0e\n" +
	...
	"\bTodoList\x12!\n" +
	"\x05todos\x18\x01 \x03(\v2\v.proto.TodoR\x05todos2\xe5\x01\n" +
	"\vTodoService\x12(\n" +
	"\n" +
	"CreateTodo\x12\v.proto.Todo\x1a\v.proto.Todo\"\x00\x12'\n" +
	"\aGetTodo\x12\r.proto.TodoId\x1a\v.proto.Todo\"\x00\x12,\n" +
	"\tListTodos\x12\f.proto.Empty\x1a\x0f.proto.TodoList\"\x00\x12(\n" +
	"\n" +
	"UpdateTodo\x12\v.proto.Todo\x1a\v.proto.Todo\"\x00\x12+\n" +
	"\n" +
	"DeleteTodo\x12\r.proto.TodoId\x1a\f.proto.Empty\"\x00B/Z-github.com/afzalsabbir/go-todo-grpc-app/protob\x06proto3"
...
var file_proto_todo_proto_depIdxs = []int32{
	2, // 0: proto.TodoList.todos:type_name -> proto.Todo
	2, // 1: proto.TodoService.CreateTodo:input_type -> proto.Todo
	1, // 2: proto.TodoService.GetTodo:input_type -> proto.TodoId
	0, // 3: proto.TodoService.ListTodos:input_type -> proto.Empty
	2, // 4: proto.TodoService.UpdateTodo:input_type -> proto.Todo
	1, // 5: proto.TodoService.DeleteTodo:input_type -> proto.TodoId
	2, // 6: proto.TodoService.CreateTodo:output_type -> proto.Todo
	2, // 7: proto.TodoService.GetTodo:output_type -> proto.Todo
	3, // 8: proto.TodoService.ListTodos:output_type -> proto.TodoList
	2, // 9: proto.TodoService.UpdateTodo:output_type -> proto.Todo
	0, // 10: proto.TodoService.DeleteTodo:output_type -> proto.Empty
